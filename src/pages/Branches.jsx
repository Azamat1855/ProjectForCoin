...
function Branches(){
  ...
  const Submit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          name: "", address: "", workTime: "", phone: "", branchManager: "", mainChief: "",
        });
        setShowForm(false);
      } else {
  ...
  const Edit = (id) => {
    ...
    if (branchToEdit) {
      setFormData({
        name: branchToEdit.name, address: branchToEdit.address, workTime: branchToEdit.workTime, phone: branchToEdit.phone, branchManager: branchToEdit.branchManager, mainChief: branchToEdit.mainChief,
      });
