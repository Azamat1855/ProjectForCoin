...
const Branches = () => {
  ...
  const commitBranch = () => {
    ...
    if (!name || !address || !openTime || !workHours || !manager || !chief || !phone) {
  ...
  >
    <div className="flex justify-between border-b py-5">
      <div className="flex flex-col">
        <h4 className="text-[21px] font-bold"><input
      type="text"
    ...
    /></h4>
      ...
      <div>
        <p className="text-emerald-600"><input
          type="text"
